...
import com.sunzn.menu.library.SlidingMenu.OnClosedListener;
import com.sunzn.menu.library.SlidingMenu.OnOpenedListener;

import java.util.ArrayList;
import java.util.List;
//import com.sunzn.menu.library.SlidingMenu.OnCloseListener;
//import com.sunzn.menu.library.SlidingMenu.OnOpenListener;
...
public class CustomViewAbove extends ViewGroup {
    ...
    protected int mTouchMode = SlidingMenu.TOUCH_MODE_MARGIN;
    ...
    private boolean thisTouchAllowed(MotionEvent ev) {
        ...
        if (isMenuOpen()) {
            ...
            switch (mTouchMode) {
                case SlidingMenu.TOUCH_MODE_FULLSCREEN:
                    return !isInIgnoredView(ev);
                case SlidingMenu.TOUCH_MODE_NONE:
                    return false;
                case SlidingMenu.TOUCH_MODE_MARGIN:
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        // Draw the margin drawable of behind view if needed.
        mViewBehind.drawShadow(mContent, canvas);
        mViewBehind.drawFade(mContent, canvas, getPercentOpen());
        mViewBehind.drawSelector(mContent, canvas, getPercentOpen());

        // Draw the margin drawable of above view if needed.
